...
- Concurrent connection limit to prevent resource exhaustion
- Exponential backoff on accept errors for stability
- Cloud metadata endpoint blocking (SSRF mitigation)
...
| `-max-connections` | `1024` | Maximum number of concurrent connections |
